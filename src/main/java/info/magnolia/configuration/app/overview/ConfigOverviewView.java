...
/**
 * Config overview sub-app view interface.
 */
public interface ConfigOverviewView extends View {

    void setConfigDataSource(ConfigurationContainer dataSource);
    ...
    /**
     * Possible config data sorting options.
     */
    enum DefinitionAggregationType {
        registry,
        module,
    }
