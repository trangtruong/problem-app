...
public class Noun {
    ...
    static
    {
        ...
        busses.add("buses"); busses.add("busses");
        ...
        hoof.add("hooves"); hoof.add("hoofs");
        ...
        octopus.add("octopodes"); octopus.add("octopi");
        ...
        scarf.add("scarves"); scarf.add("scarfs");
